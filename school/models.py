...
class Grade(models.Model):
    ...
    subject = models.ForeignKey(
        "SchoolSubject", on_delete=models.SET_NULL, blank=True, null=True
    )
...
class SchoolClass(models.Model):
    ...
    supervising_teacher = models.OneToOneField(
...
class Student(models.Model):
    ...
    school_class = models.ForeignKey(
        "SchoolClass", on_delete=models.SET_NULL, blank=True, null=True
    )
    school = models.ForeignKey(
        "School", on_delete=models.SET_NULL, blank=True, null=True
    )
