...
urlpatterns= [
    ...
    path('schools/<int:pk>/classes/', ListSchoolClasses.as_view(), name='list-school-classes'), 
    ...
    path('subjects/<int:pk1>/students/<int:pk2>/grades/', StudentGradeInSubject.as_view(), name='student-grade-in-subject'),
